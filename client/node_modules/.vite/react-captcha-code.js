...
// node_modules/react-captcha-code/build/es/captcha.js
...
function stylis_min(W2) {
  ...
  function H2(d2, c2, e2, h2, a2, m, b2, v2, n2, q2) {
    for (var g2 = 0, x2 = c2, w3; g2 < A2; ++g2) {
      switch (w3 = S3[g2].call(B2, d2, x2, e2, h2, a2, m, b2, v2, n2, q2)) {
        case void 0:
        case false:
        case true:
        case null:
  ...
  var ca = /^\0+/g, N2 = /[\0\r\f]/g, aa = /: */g, ka = /zoo|gra/, ma = /([,: ])(transform)/g, ia = /,\r+?/g, F2 = /([\t\r\n ])*\f?&/g, fa = /@(k\w+)\s*(\S*)\s*/, Q2 = /::(place)/g, ha = /:(read-only)/g, G2 = /[svh]\w+-[tblr]{2}/, da = /\(\s*(.*)\s*\)/g, oa = /([\s\S]*?);/g, ba = /-self|flex-/g, na = /[^]*?(:[rp][el]a[\w-]+)[^]*/, la = /stretch|:\s*\w+\-(?:conte|avail)/, ja = /([^-])(image-set\()/, z2 = 1, D2 = 1, E2 = 0, w2 = 1, O = [], S3 = [], A2 = 0, R2 = null, Y2 = 0, V2 = "";
  B2.use = T2;
  B2.set = U2;
  W2 !== void 0 && U2(W2);
  return B2;
...
function qe(e2, t2, n2) {
  ...
  }(e2) : p, g2 = t2.displayName && t2.componentId ? Te(t2.displayName) + "-" + t2.componentId : t2.componentId || h2, S3 = o2 && e2.attrs ? Array.prototype.concat(e2.attrs, c2).filter(Boolean) : c2, A2 = t2.shouldForwardProp;
  ...
  var C, I2 = new se(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(Re(t4, (0, import_react.useContext)(Ge), a3) || E, t4, o3), y2 = f2[0], g3 = f2[1], S4 = function(e5, t5, n4, r3) {
      ...
      return t4.style && g3.style !== t4.style && (C2.style = v({}, t4.style, {}, g3.style)), C2.className = Array.prototype.concat(c3, h3, S4 !== h3 ? S4 : null, t4.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, (0, import_react.createElement)(_2, C2);
    }(C, e3, t3, P2);
  };
  return O.displayName = f, (C = import_react.default.forwardRef(O)).attrs = S3, C.componentStyle = I2, C.displayName = f, C.shouldForwardProp = A2, C.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w, C.styledComponentId = g2, C.target = o2 ? e2.target : e2, C.withComponent = function(e3) {
...
// node_modules/react-captcha-code/build/es/style.js
...
var SCaptcha = styled_components_browser_esm_default.canvas(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  cursor: pointer;\n"], ["\n  cursor: pointer;\n"])));
var templateObject_1;

// node_modules/react-captcha-code/build/es/utils.js
function randomNum(m, n2) {
  return Math.floor(Math.random() * (n2 - m + 1) + m);
}
...
var Captcha = (0, import_react2.forwardRef)(function(_a, ref) {
  var _b = _a.height, height = _b === void 0 ? 40 : _b, _c = _a.width, width = _c === void 0 ? 100 : _c, _d = _a.bgColor, bgColor = _d === void 0 ? "#DFF0D8" : _d, _e2 = _a.charNum, charNum = _e2 === void 0 ? 4 : _e2, _f = _a.fontSize, fontSize = _f === void 0 ? 25 : _f, onChange = _a.onChange, onClick = _a.onClick, className = _a.className, onRef = _a.onRef, _g = _a.code, code = _g === void 0 ? "" : _g;
  ...
  var generateSourceCode = (0, import_react2.useCallback)(function() {
    var array = [];
    if (code) {
      return code.split("");
    }
    for (var i2 = 0; i2 < charNum; i2++) {
      var temp = originalCharacter[randomNum(0, originalCharacter.length - 1)];
      array.push(temp);
    }
    return array;
  }, [code, charNum]);
  var generateCaptcha = (0, import_react2.useCallback)(function() {
    var checkCode = "";
    if (canvas.current) {
      ...
      if (ctx) {
        ...
        for (var i2 = 0; i2 < sourceCode.length; i2++) {
          ...
          ctx.strokeText(code_1, offset + i2 * charGap, height / 2 + 8);
          ctx.beginPath();
  ...
  var handleClick = (0, import_react2.useCallback)(function() {
    if ((0, import_lodash.isFunction)(onChange) && !code) {
      var captcha = generateCaptcha();
      onChange(captcha);
    }
    if ((0, import_lodash.isFunction)(onClick)) {
      onClick();
    }
  }, [onChange, code]);
  (0, import_react2.useEffect)(function() {
  ...
  return import_react2.default.createElement(SCaptcha, { className: (0, import_classnames.default)("react-captcha", className), onClick: handleClick, height, width, ref: canvas });
});
var captcha_default = Captcha;

// node_modules/react-captcha-code/build/es/index.js
var es_default = captcha_default;

// dep:react-captcha-code
var react_captcha_code_default = es_default;
export {
  react_captcha_code_default as default
};
/**
 * @license
 ...
 */
//# sourceMappingURL=react-captcha-code.js.map
